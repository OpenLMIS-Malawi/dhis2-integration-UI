...
(function() {
    ...
    angular
        ...
        .config(dhis2ExecutionResponseBodyRoutes);

    dhis2ExecutionResponseBodyRoutes.$inject = ['modalStateProvider'];

    function dhis2ExecutionResponseBodyRoutes(modalStateProvider) {

        modalStateProvider.state('openlmis.administration.dhis2.executions.responsebody', {
